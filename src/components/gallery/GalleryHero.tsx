...
export const GalleryHero = () => {
  return (
    <section className="relative min-h-[85vh] flex items-center justify-center bg-[#030303] overflow-hidden pt-20">
      
      {/* Background Ambience */}
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-full max-w-5xl h-[600px] bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-accent-purple/20 via-accent-gold/10 to-transparent blur-[120px] pointer-events-none" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={fadeUp} className="mb-8 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/10 bg-white/5 backdrop-blur-md shadow-[0_0_20px_rgba(255,183,3,0.15)]">
            ...
            <span className="text-xs font-bold tracking-[0.2em] uppercase text-gray-300">KINGDOM ARCHIVES</span>
          </motion.div>
          ...
          <motion.div variants={fadeUp} className="text-3xl md:text-5xl font-heading font-black tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-accent-gold to-yellow-400 mb-8 drop-shadow-[0_0_15px_rgba(255,183,3,0.3)] uppercase">
            CAPTURE THE JOURNEY.
          </motion.div>

          <motion.p variants={fadeUp} className="text-gray-400 text-lg md:text-xl max-w-3xl leading-relaxed tracking-wide font-medium">
            From the first block placed to unforgettable adventures, 
            the memories of Kingdom SMP live here.
          </motion.p>
