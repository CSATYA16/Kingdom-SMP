  ...
  return (
    <section className="relative py-32 bg-[#030303] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none opacity-40">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-accent-gold/10 via-accent-purple/10 to-transparent blur-[150px]" />
      </div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.h2 
            variants={fadeUp} 
            className="text-4xl md:text-6xl lg:text-7xl font-heading font-black tracking-widest text-white mb-12 uppercase drop-shadow-[0_0_20px_rgba(255,183,3,0.2)]"
          >
            CREATE THE NEXT <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-gold to-yellow-400">MEMORY.</span>
          </motion.h2>
